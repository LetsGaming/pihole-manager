...
const ROUTES = [
  ...
  { path: '/dashboard',  name: 'Dashboard',    component: stub('Dashboard'),  meta: { title: 'Dashboard' } },
  { path: '/query-log',  name: 'QueryLog',     component: stub('QueryLog'),   meta: { title: 'Query Log' } },
  { path: '/blocklists', name: 'BlockLists',   component: stub('BlockLists'), meta: { title: 'Block Lists' } },
  { path: '/hardware',   name: 'Hardware',     component: stub('Hardware'),   meta: { title: 'Hardware' } },
  { path: '/statistics', name: 'Statistics',   component: stub('Statistics'), meta: { title: 'Statistics' } },
  { path: '/settings',   name: 'Settings',     component: stub('Settings'),   meta: { title: 'Settings' } },
  { path: '/docs',       name: 'Documentation',component: stub('Docs'),       meta: { title: 'Documentation' } },
];
