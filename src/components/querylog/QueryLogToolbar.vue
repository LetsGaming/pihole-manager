  ...
  <div class="log-toolbar card mb-3">
    <div class="flex items-center gap-2" style="flex-wrap: wrap">
      ...
      <select
        ...
        :value="instanceId"
        @change="
          $emit('update:instanceId', ($event.target as HTMLSelectElement).value)
        "
      >
